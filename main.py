#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To Itzmebeluga
...
\033[1;91m [⚡\033[1;97mAuthor Name: ItzmeBeluga     ⚡\033[1;91m]
\033[1;91m [⚡\033[1;97mYutube Chnl: Coming Soon ⚡\033[1;91m]
...
\033[1;95m«-_-_-_-_-_-_-_-_-\033[1;91mHuntter\033[1;95m-_-_-_-_-_-_-_-_-»
 """
CorrectUsername = "Beluga"
CorrectPassword = "belu"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:ItzmeBeluga
	    time.sleep(2)
            loop = 'false'
        else:
            print "\033[1;93mWrong Password"
            os.system('xdg-open https://t.me/itzmebeluga')
    else:
...
def menu():
	...
	try:
		...
		keluar()
	os.system("clear") #Dev:itzmeBeluga
	print logo
